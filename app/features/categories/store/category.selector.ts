...
export const selectCategoriesResults = (state: RootState) => state.categories.results;
...
export const selectSuccesCategoryFlag = (state: RootState) => state.categories.success;
